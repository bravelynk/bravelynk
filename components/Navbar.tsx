      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            className="fixed inset-x-0 top-[72px] z-40 border-b border-black/5 bg-white/98 px-5 pb-8 pt-6 shadow-lg backdrop-blur-md dark:border-white/10 dark:bg-ink-900/98 lg:hidden"
          >
